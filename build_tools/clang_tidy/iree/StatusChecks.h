...
#ifndef IREE_BUILD_TOOLS_CLANG_TIDY_IREE_STATUS_CHECKS_H_
#define IREE_BUILD_TOOLS_CLANG_TIDY_IREE_STATUS_CHECKS_H_

#include "clang-tidy/ClangTidyCheck.h"

namespace clang::tidy::iree {

class DiscardedStatusCheck final : public ClangTidyCheck {
 public:
