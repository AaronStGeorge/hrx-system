...
class PerfettoTest(unittest.TestCase):
    ...
    def test_build_trace_projects_dispatch_scoped_counters_as_counter_tracks(self):
        builder = _FakeTraceProtoBuilder()
        trace_bytes, stats = perfetto.build_trace(
            [
                {"record_type": "device", "physical_device_ordinal": 0},
                ...
                },
                {
                    ...
                    "counter_set_id": 1,
                    "scope": "dispatch",
                    "dispatch_event_id": 11,
                    "submission_id": 13,
                    "command_buffer_id": 17,
                    "command_index": 19,
                    "executable_id": 23,
                    "function_ordinal": 29,
                    "physical_device_ordinal": 0,
        ...
        counter_values = sorted(
            getattr(packet.track_event, "counter_value", None)
        ...
        self.assertTrue(trace_bytes.startswith(b"packets="))
        self.assertEqual(2, stats.counter_samples)
        self.assertEqual(2, stats.dispatch_scoped_counter_values)
        self.assertEqual(0, stats.skipped_dispatch_scoped_counter_samples)
        self.assertEqual(0, stats.skipped_dispatch_scoped_counter_values)
        self.assertEqual(2, len(counter_packets))
        self.assertEqual([6, 30], counter_values)
        self.assertIn("dispatch-scoped counters", track_names)
        self.assertIn("amdgpu.pmc", track_names)
        self.assertIn("SQ_WAVES", track_names)
        self.assertIn("SQ_BUSY_CYCLES", track_names)
    ...
    def test_build_trace_projects_command_buffer_metadata(self):
        ...
        trace_bytes, stats = perfetto.build_trace(
            [
                ...
                {
                    "record_type": "executable_function",
                    "executable_id": 5,
                    "function_ordinal": 1,
