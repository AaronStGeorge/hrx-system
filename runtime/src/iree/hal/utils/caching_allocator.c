...
iree_hal_caching_allocator_virtual_memory_query_granularity(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
...
static const iree_hal_allocator_vtable_t iree_hal_caching_allocator_vtable = {
    ...
    .supports_virtual_memory =
        iree_hal_caching_allocator_supports_virtual_memory,
    .virtual_memory_query_granularity =
        iree_hal_caching_allocator_virtual_memory_query_granularity,
    .virtual_memory_reserve = iree_hal_caching_allocator_virtual_memory_reserve,
    .virtual_memory_release = iree_hal_caching_allocator_virtual_memory_release,
    .physical_memory_allocate =
        iree_hal_caching_allocator_physical_memory_allocate,
    .physical_memory_free = iree_hal_caching_allocator_physical_memory_free,
    .virtual_memory_map = iree_hal_caching_allocator_virtual_memory_map,
    .virtual_memory_unmap = iree_hal_caching_allocator_virtual_memory_unmap,
    .virtual_memory_protect = iree_hal_caching_allocator_virtual_memory_protect,
    .virtual_memory_advise = iree_hal_caching_allocator_virtual_memory_advise,
};
