...
enum {
  ...
  IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_DWORD_COUNT = 7,
  ...
  IREE_HAL_AMDGPU_PM4_HDR_IT_OPCODE_NOP = 0x10,
  ...
  IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_COHER_SIZE_HI = 0x00FFFFFFu,
  IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX10_COHER_SIZE_HI = 0x01FFFFFFu,
  IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_POLL_INTERVAL = 0x0000000Au,
  IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_CP_COHER_CNTL_TC_WB_ACTION_ENA = 1u
                                                                        << 18,
  IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_CP_COHER_CNTL_TCL1_ACTION_ENA = 1u << 22,
  IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_CP_COHER_CNTL_TC_ACTION_ENA = 1u << 23,
  IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_CP_COHER_CNTL_SH_KCACHE_ACTION_ENA =
      1u << 27,
  IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_CP_COHER_CNTL_SH_ICACHE_ACTION_ENA =
      1u << 29,
  IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_CP_COHER_CNTL_CONSERVATIVE =
      IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_CP_COHER_CNTL_SH_ICACHE_ACTION_ENA |
      IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_CP_COHER_CNTL_SH_KCACHE_ACTION_ENA |
      IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_CP_COHER_CNTL_TC_ACTION_ENA |
      IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_CP_COHER_CNTL_TCL1_ACTION_ENA |
      IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_CP_COHER_CNTL_TC_WB_ACTION_ENA,
  ...
  IREE_HAL_AMDGPU_PM4_COMPUTE_PGM_RSRC3_GFX10_REGISTER = 0x00002E28,
  IREE_HAL_AMDGPU_PM4_COMPUTE_PGM_RSRC3_GFX9_REGISTER = 0x00002E2D,
...
// Appends a gfx9 ACQUIRE_MEM packet for cache management. The packet form
// matches the gfx9 compute sequence used by Mesa and the Linux kernel:
...
static inline bool iree_hal_amdgpu_pm4_ib_builder_emit_acquire_mem_gfx9(
  ...
  dword[2] = IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_COHER_SIZE;
  dword[3] = IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_GFX9_COHER_SIZE_HI;
  dword[4] = 0;
  dword[5] = 0;
  dword[6] = IREE_HAL_AMDGPU_PM4_ACQUIRE_MEM_POLL_INTERVAL;
  return true;
