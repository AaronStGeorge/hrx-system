...
// Creates an empty public module handle with storage for one internal module.
LOOMC_API_PRIVATE loomc_status_t loomc_module_create_empty(
    loomc_context_t* context, loomc_allocator_t allocator,
    loomc_host_size_t block_size, loomc_module_t** out_module);
...
// Returns the stable arena block pool backing the internal module.
