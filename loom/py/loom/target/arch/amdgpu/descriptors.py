...
AMDGPU_GFX950_CORE_DESCRIPTOR_SET = DescriptorSet(
    ...
    c_header_path=Path("loom/src/loom/target/arch/amdgpu/descriptors.h"),
    c_source_path=Path("loom/src/loom/target/arch/amdgpu/descriptors.c"),
    header_guard="LOOM_TARGET_ARCH_AMDGPU_DESCRIPTORS_H_",
    public_header="loom/target/arch/amdgpu/descriptors.h",
