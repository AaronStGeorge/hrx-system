...
target_snapshot = Op(
    ...
    attrs=[
        ...
        AttrDef("codegen_format", ATTR_TYPE_ENUM, enum_def=SnapshotCodegenFormat),
        AttrDef("target_triple", ATTR_TYPE_STRING),
        AttrDef("data_layout", ATTR_TYPE_STRING),
        AttrDef("artifact_format", ATTR_TYPE_ENUM, enum_def=ArtifactFormatAttr),
...
target_export = Op(
    ...
    attrs=[
        ...
        AttrDef("abi", ATTR_TYPE_ENUM, enum_def=ExportAbiKind),
        AttrDef("linkage", ATTR_TYPE_ENUM, enum_def=ExportLinkage),
