...
// Pass descriptor entry points for low allocation and materialization.

#ifndef LOOM_CODEGEN_LOW_PASSES_ALLOCATION_H_
#define LOOM_CODEGEN_LOW_PASSES_ALLOCATION_H_
...
#endif  // LOOM_CODEGEN_LOW_PASSES_ALLOCATION_H_
