...
enum {
  ...
  LOOM_OP_KERNEL_EXIT = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 2),
  LOOM_OP_KERNEL_BARRIER = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 3),
  LOOM_OP_KERNEL_ASYNC_COPY = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 4),
  LOOM_OP_KERNEL_ASYNC_COPY_MASK = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 5),
  LOOM_OP_KERNEL_ASYNC_GATHER = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 6),
  LOOM_OP_KERNEL_ASYNC_GATHER_MASK = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 7),
  LOOM_OP_KERNEL_ASYNC_GROUP = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 8),
  LOOM_OP_KERNEL_ASYNC_WAIT = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 9),
  LOOM_OP_KERNEL_TENSOR_LDS_DESCRIPTOR = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 10),
  LOOM_OP_KERNEL_ASYNC_TENSOR_LOAD_TO_LDS = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 11),
  LOOM_OP_KERNEL_ASYNC_TENSOR_STORE_FROM_LDS = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 12),
  LOOM_OP_KERNEL_ASYNC_CLUSTER_GATHER = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 13),
  LOOM_OP_KERNEL_ASYNC_CLUSTER_GATHER_MASK = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 14),
  LOOM_OP_KERNEL_WORKITEM_ID = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 15),
  LOOM_OP_KERNEL_WORKGROUP_ID = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 16),
  LOOM_OP_KERNEL_WORKGROUP_SIZE = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 17),
  LOOM_OP_KERNEL_WORKGROUP_COUNT = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 18),
  LOOM_OP_KERNEL_WORKITEM_DISPATCH_ID = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 19),
  LOOM_OP_KERNEL_SUBGROUP_ID = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 20),
  LOOM_OP_KERNEL_SUBGROUP_COUNT = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 21),
  LOOM_OP_KERNEL_SUBGROUP_SIZE = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 22),
  LOOM_OP_KERNEL_SUBGROUP_LANE_ID = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 23),
  LOOM_OP_KERNEL_SUBGROUP_SHUFFLE = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 24),
  LOOM_OP_KERNEL_SUBGROUP_BROADCAST = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 25),
  LOOM_OP_KERNEL_SUBGROUP_BROADCAST_FIRST = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 26),
  LOOM_OP_KERNEL_SUBGROUP_REDUCE = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 27),
  LOOM_OP_KERNEL_SUBGROUP_SCAN = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 28),
  LOOM_OP_KERNEL_SUBGROUP_VOTE_ANY = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 29),
  LOOM_OP_KERNEL_SUBGROUP_VOTE_ALL = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 30),
  LOOM_OP_KERNEL_SUBGROUP_VOTE_BALLOT = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 31),
  LOOM_OP_KERNEL_SUBGROUP_ACTIVE_MASK = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 32),
  LOOM_OP_KERNEL_SUBGROUP_MATCH_ANY = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 33),
  LOOM_OP_KERNEL_SUBGROUP_MATCH_ALL = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 34),
  LOOM_OP_KERNEL_WORKGROUP_REDUCE = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 35),
  LOOM_OP_KERNEL_WORKGROUP_VOTE_ANY = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 36),
  LOOM_OP_KERNEL_WORKGROUP_VOTE_ALL = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 37),
  LOOM_OP_KERNEL_WORKGROUP_VOTE_COUNT = LOOM_OP_KIND(LOOM_DIALECT_KERNEL, 38),
  LOOM_OP_KERNEL_COUNT_ = 39,
};
