...
enum {
  ...
  LOOM_OP_SCALAR_SELECT = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 63),
  LOOM_OP_SCALAR_ISNANF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 64),
  LOOM_OP_SCALAR_ISINFF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 65),
  LOOM_OP_SCALAR_ISFINITEF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 66),
  LOOM_OP_SCALAR_SIGNF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 67),
  LOOM_OP_SCALAR_SIGNI = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 68),
  LOOM_OP_SCALAR_SITOFP = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 69),
  LOOM_OP_SCALAR_UITOFP = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 70),
  LOOM_OP_SCALAR_FPTOSI = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 71),
  LOOM_OP_SCALAR_FPTOUI = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 72),
  LOOM_OP_SCALAR_EXTF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 73),
  LOOM_OP_SCALAR_FPTRUNC = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 74),
...
// LOOM_OP_SCALAR_SELECT: Conditional select: returns true_value if condition is true, else false_value.
// %result = scalar.select %cond, %t, %f : f32
LOOM_DEFINE_ISA(loom_scalar_select_isa, LOOM_OP_SCALAR_SELECT)
LOOM_DEFINE_OPERAND(loom_scalar_select_condition, 0)
LOOM_DEFINE_OPERAND(loom_scalar_select_true_value, 1)
LOOM_DEFINE_OPERAND(loom_scalar_select_false_value, 2)
LOOM_DEFINE_RESULT(loom_scalar_select_result, 0)
iree_status_t loom_scalar_select_build(
    loom_builder_t* builder,
    ...
    loom_location_id_t location,
    loom_op_t** out_op);
extern const loom_op_vtable_t loom_scalar_select_vtable;
...
iree_status_t loom_scalar_index_cast_build(
    ...
    loom_type_t input_type, loom_type_t result_type,
    loom_location_id_t location, loom_op_t** out_op);
extern const loom_op_vtable_t loom_scalar_index_cast_vtable;
