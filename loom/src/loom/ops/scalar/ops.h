...
enum {
  ...
  LOOM_OP_SCALAR_COPYSIGNF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 28),
  LOOM_OP_SCALAR_EXPF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 29),
  LOOM_OP_SCALAR_EXP2F = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 30),
  LOOM_OP_SCALAR_EXPM1F = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 31),
  LOOM_OP_SCALAR_LOGF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 32),
  LOOM_OP_SCALAR_LOG2F = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 33),
  LOOM_OP_SCALAR_LOG10F = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 34),
  LOOM_OP_SCALAR_LOG1PF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 35),
  LOOM_OP_SCALAR_POWF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 36),
  LOOM_OP_SCALAR_SQRTF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 37),
  LOOM_OP_SCALAR_RSQRTF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 38),
  LOOM_OP_SCALAR_CBRTF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 39),
  LOOM_OP_SCALAR_SINF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 40),
  LOOM_OP_SCALAR_COSF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 41),
  LOOM_OP_SCALAR_TANF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 42),
  LOOM_OP_SCALAR_ASINF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 43),
  LOOM_OP_SCALAR_ACOSF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 44),
  LOOM_OP_SCALAR_ATANF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 45),
  LOOM_OP_SCALAR_ATAN2F = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 46),
  LOOM_OP_SCALAR_SINHF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 47),
  LOOM_OP_SCALAR_COSHF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 48),
  LOOM_OP_SCALAR_TANHF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 49),
  LOOM_OP_SCALAR_ASINHF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 50),
  LOOM_OP_SCALAR_ACOSHF = LOOM_OP_KIND(LOOM_DIALECT_SCALAR, 51),
