...
enum {
  ...
  LOOM_OP_TEST_DEFLATE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 17),
  LOOM_OP_TEST_ASSUME = LOOM_OP_KIND(LOOM_DIALECT_TEST, 18),
  LOOM_OP_TEST_CONVERT = LOOM_OP_KIND(LOOM_DIALECT_TEST, 19),
  LOOM_OP_TEST_REDUCE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 20),
  LOOM_OP_TEST_READ_RESOURCE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 21),
  LOOM_OP_TEST_WRITE_RESOURCE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 22),
  LOOM_OP_TEST_MUTATE_RESOURCE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 23),
  LOOM_OP_TEST_ALLOC = LOOM_OP_KIND(LOOM_DIALECT_TEST, 24),
  LOOM_OP_TEST_ISOLATED_REGION = LOOM_OP_KIND(LOOM_DIALECT_TEST, 25),
  LOOM_OP_TEST_COUNTER = LOOM_OP_KIND(LOOM_DIALECT_TEST, 26),
  LOOM_OP_TEST_DIM = LOOM_OP_KIND(LOOM_DIALECT_TEST, 27),
  LOOM_OP_TEST_FACT_RANGE_LO = LOOM_OP_KIND(LOOM_DIALECT_TEST, 28),
  LOOM_OP_TEST_FACT_RANGE_HI = LOOM_OP_KIND(LOOM_DIALECT_TEST, 29),
  LOOM_OP_TEST_FACT_DIVISOR = LOOM_OP_KIND(LOOM_DIALECT_TEST, 30),
  LOOM_OP_TEST_FACT_NON_NEGATIVE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 31),
  LOOM_OP_TEST_FACT_NON_ZERO = LOOM_OP_KIND(LOOM_DIALECT_TEST, 32),
  LOOM_OP_TEST_FACT_POSITIVE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 33),
  LOOM_OP_TEST_FACT_POWER_OF_TWO = LOOM_OP_KIND(LOOM_DIALECT_TEST, 34),
  LOOM_OP_TEST_COUNT_ = 35,
};
