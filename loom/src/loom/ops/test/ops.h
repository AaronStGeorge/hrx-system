...
enum {
  ...
  LOOM_OP_TEST_DECL = LOOM_OP_KIND(LOOM_DIALECT_TEST, 21),
  LOOM_OP_TEST_RECORD = LOOM_OP_KIND(LOOM_DIALECT_TEST, 22),
  LOOM_OP_TEST_ATTRS = LOOM_OP_KIND(LOOM_DIALECT_TEST, 23),
  LOOM_OP_TEST_OPERAND_DICT = LOOM_OP_KIND(LOOM_DIALECT_TEST, 24),
  LOOM_OP_TEST_ATTR_TABLE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 25),
  LOOM_OP_TEST_REGION_TABLE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 26),
  LOOM_OP_TEST_DEFLATE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 27),
  LOOM_OP_TEST_ASSUME = LOOM_OP_KIND(LOOM_DIALECT_TEST, 28),
  LOOM_OP_TEST_CONVERT = LOOM_OP_KIND(LOOM_DIALECT_TEST, 29),
  LOOM_OP_TEST_REDUCE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 30),
  LOOM_OP_TEST_READ_RESOURCE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 31),
  LOOM_OP_TEST_WRITE_RESOURCE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 32),
  LOOM_OP_TEST_MUTATE_RESOURCE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 33),
  LOOM_OP_TEST_ALLOC = LOOM_OP_KIND(LOOM_DIALECT_TEST, 34),
  LOOM_OP_TEST_ISOLATED_REGION = LOOM_OP_KIND(LOOM_DIALECT_TEST, 35),
  LOOM_OP_TEST_COUNTER = LOOM_OP_KIND(LOOM_DIALECT_TEST, 36),
  LOOM_OP_TEST_DIM = LOOM_OP_KIND(LOOM_DIALECT_TEST, 37),
  LOOM_OP_TEST_FACT_RANGE_LO = LOOM_OP_KIND(LOOM_DIALECT_TEST, 38),
  LOOM_OP_TEST_FACT_RANGE_HI = LOOM_OP_KIND(LOOM_DIALECT_TEST, 39),
  LOOM_OP_TEST_FACT_ALL_EQUAL_RANGE_LO = LOOM_OP_KIND(LOOM_DIALECT_TEST, 40),
  LOOM_OP_TEST_FACT_ALL_EQUAL_RANGE_HI = LOOM_OP_KIND(LOOM_DIALECT_TEST, 41),
  LOOM_OP_TEST_FACT_DIVISOR = LOOM_OP_KIND(LOOM_DIALECT_TEST, 42),
  LOOM_OP_TEST_FACT_NON_NEGATIVE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 43),
  LOOM_OP_TEST_FACT_NON_ZERO = LOOM_OP_KIND(LOOM_DIALECT_TEST, 44),
  LOOM_OP_TEST_FACT_POSITIVE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 45),
  LOOM_OP_TEST_FACT_POWER_OF_TWO = LOOM_OP_KIND(LOOM_DIALECT_TEST, 46),
  LOOM_OP_TEST_FACT_IS_VECTOR_IOTA = LOOM_OP_KIND(LOOM_DIALECT_TEST, 47),
  LOOM_OP_TEST_FACT_IS_VECTOR_PREFIX_MASK = LOOM_OP_KIND(LOOM_DIALECT_TEST, 48),
  LOOM_OP_TEST_FACT_ENCODING_LAYOUT_KIND = LOOM_OP_KIND(LOOM_DIALECT_TEST, 49),
  LOOM_OP_TEST_FACT_ENCODING_LAYOUT_STRIDE_HI = LOOM_OP_KIND(LOOM_DIALECT_TEST, 50),
  LOOM_OP_TEST_FACT_ENCODING_MATRIX_FIELD = LOOM_OP_KIND(LOOM_DIALECT_TEST, 51),
  LOOM_OP_TEST_FACT_IS_BUFFER_REFERENCE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 52),
  LOOM_OP_TEST_FACT_IS_VIEW_REFERENCE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 53),
  LOOM_OP_TEST_FACT_BUFFER_MEMORY_SPACE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 54),
  LOOM_OP_TEST_FACT_VIEW_MEMORY_SPACE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 55),
  LOOM_OP_TEST_FACT_VIEW_ROOT_MATCHES = LOOM_OP_KIND(LOOM_DIALECT_TEST, 56),
  LOOM_OP_TEST_FACT_ALIAS_SCOPE_KNOWN = LOOM_OP_KIND(LOOM_DIALECT_TEST, 57),
  LOOM_OP_TEST_FACT_ALIAS_SCOPE_MATCHES = LOOM_OP_KIND(LOOM_DIALECT_TEST, 58),
  LOOM_OP_TEST_FACT_VIEW_BYTE_OFFSET_LO = LOOM_OP_KIND(LOOM_DIALECT_TEST, 59),
  LOOM_OP_TEST_FACT_VIEW_BYTE_OFFSET_HI = LOOM_OP_KIND(LOOM_DIALECT_TEST, 60),
  LOOM_OP_TEST_FACT_VIEW_BYTE_LENGTH_LO = LOOM_OP_KIND(LOOM_DIALECT_TEST, 61),
  LOOM_OP_TEST_FACT_VIEW_BYTE_LENGTH_HI = LOOM_OP_KIND(LOOM_DIALECT_TEST, 62),
  LOOM_OP_TEST_FACT_VIEW_MIN_ALIGNMENT = LOOM_OP_KIND(LOOM_DIALECT_TEST, 63),
  LOOM_OP_TEST_FACT_BUFFER_MIN_ALIGNMENT = LOOM_OP_KIND(LOOM_DIALECT_TEST, 64),
  LOOM_OP_TEST_FACT_VIEW_ROOT_MIN_ALIGNMENT = LOOM_OP_KIND(LOOM_DIALECT_TEST, 65),
  LOOM_OP_TEST_FACT_VIEW_ELEMENT_BYTES = LOOM_OP_KIND(LOOM_DIALECT_TEST, 66),
  LOOM_OP_TEST_FACT_IS_STORAGE_REFERENCE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 67),
  LOOM_OP_TEST_FACT_STORAGE_SAME_BACKING = LOOM_OP_KIND(LOOM_DIALECT_TEST, 68),
  LOOM_OP_TEST_FACT_STORAGE_BYTE_OFFSET_LO = LOOM_OP_KIND(LOOM_DIALECT_TEST, 69),
  LOOM_OP_TEST_FACT_STORAGE_BYTE_OFFSET_HI = LOOM_OP_KIND(LOOM_DIALECT_TEST, 70),
  LOOM_OP_TEST_FACT_STORAGE_BYTE_OFFSET_DIVISOR = LOOM_OP_KIND(LOOM_DIALECT_TEST, 71),
  LOOM_OP_TEST_FACT_STORAGE_BYTE_LENGTH_LO = LOOM_OP_KIND(LOOM_DIALECT_TEST, 72),
  LOOM_OP_TEST_FACT_STORAGE_BYTE_LENGTH_HI = LOOM_OP_KIND(LOOM_DIALECT_TEST, 73),
  LOOM_OP_TEST_FACT_STORAGE_MIN_ALIGNMENT = LOOM_OP_KIND(LOOM_DIALECT_TEST, 74),
  LOOM_OP_TEST_FACT_STORAGE_SPACE = LOOM_OP_KIND(LOOM_DIALECT_TEST, 75),
  LOOM_OP_TEST_REGION_SYNTAX = LOOM_OP_KIND(LOOM_DIALECT_TEST, 76),
  LOOM_OP_TEST_LOW_ASM_REGION = LOOM_OP_KIND(LOOM_DIALECT_TEST, 77),
  LOOM_OP_TEST_CLAUSE_CONSTANT = LOOM_OP_KIND(LOOM_DIALECT_TEST, 78),
