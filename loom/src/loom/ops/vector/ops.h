...
enum {
  ...
  LOOM_OP_VECTOR_COPYSIGNF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 50),
  LOOM_OP_VECTOR_FMAF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 51),
  LOOM_OP_VECTOR_ADDI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 52),
  LOOM_OP_VECTOR_SUBI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 53),
  LOOM_OP_VECTOR_MULI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 54),
  LOOM_OP_VECTOR_DIVSI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 55),
  LOOM_OP_VECTOR_DIVUI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 56),
  LOOM_OP_VECTOR_REMSI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 57),
  LOOM_OP_VECTOR_REMUI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 58),
  LOOM_OP_VECTOR_CEILDIVSI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 59),
  LOOM_OP_VECTOR_CEILDIVUI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 60),
  LOOM_OP_VECTOR_FLOORDIVSI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 61),
  LOOM_OP_VECTOR_NEGI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 62),
  LOOM_OP_VECTOR_ABSI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 63),
  LOOM_OP_VECTOR_MINSI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 64),
  LOOM_OP_VECTOR_MAXSI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 65),
  LOOM_OP_VECTOR_MINUI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 66),
  LOOM_OP_VECTOR_MAXUI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 67),
  LOOM_OP_VECTOR_FMAI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 68),
  LOOM_OP_VECTOR_ANDI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 69),
  LOOM_OP_VECTOR_ORI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 70),
  LOOM_OP_VECTOR_XORI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 71),
  LOOM_OP_VECTOR_SHLI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 72),
  LOOM_OP_VECTOR_SHRSI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 73),
  LOOM_OP_VECTOR_SHRUI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 74),
  LOOM_OP_VECTOR_ROTLI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 75),
  LOOM_OP_VECTOR_ROTRI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 76),
  LOOM_OP_VECTOR_CTLZI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 77),
  LOOM_OP_VECTOR_CTTZI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 78),
  LOOM_OP_VECTOR_CTPOPI = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 79),
  LOOM_OP_VECTOR_EXPF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 80),
  LOOM_OP_VECTOR_EXP2F = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 81),
  LOOM_OP_VECTOR_EXPM1F = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 82),
  LOOM_OP_VECTOR_LOGF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 83),
  LOOM_OP_VECTOR_LOG2F = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 84),
  LOOM_OP_VECTOR_LOG10F = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 85),
  LOOM_OP_VECTOR_LOG1PF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 86),
  LOOM_OP_VECTOR_POWF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 87),
  LOOM_OP_VECTOR_SQRTF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 88),
  LOOM_OP_VECTOR_RSQRTF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 89),
  LOOM_OP_VECTOR_CBRTF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 90),
  LOOM_OP_VECTOR_SINF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 91),
  LOOM_OP_VECTOR_COSF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 92),
  LOOM_OP_VECTOR_TANF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 93),
  LOOM_OP_VECTOR_ASINF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 94),
  LOOM_OP_VECTOR_ACOSF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 95),
  LOOM_OP_VECTOR_ATANF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 96),
  LOOM_OP_VECTOR_ATAN2F = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 97),
  LOOM_OP_VECTOR_SINHF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 98),
  LOOM_OP_VECTOR_COSHF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 99),
  LOOM_OP_VECTOR_TANHF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 100),
  LOOM_OP_VECTOR_ASINHF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 101),
  LOOM_OP_VECTOR_ACOSHF = LOOM_OP_KIND(LOOM_DIALECT_VECTOR, 102),
