...
static const loom_vector_to_scalar_descriptor_t kVectorToScalarDescriptors[] = {
    ...
    {LOOM_OP_VECTOR_DOT2F, LOOM_OP_KIND_UNKNOWN,
     LOOM_VECTOR_TO_SCALAR_LANE_DOT2F, 0, 0, false, false, false, 2},
    ...
    {LOOM_OP_VECTOR_TABLE_LOOKUP, LOOM_OP_KIND_UNKNOWN,
     LOOM_VECTOR_TO_SCALAR_LANE_TABLE_LOOKUP, 0, 0, false, false, false,
     UINT8_MAX},
    {LOOM_OP_VECTOR_TABLE_QUANTIZE, LOOM_OP_KIND_UNKNOWN,
     LOOM_VECTOR_TO_SCALAR_LANE_TABLE_QUANTIZE, 0, 0, false, false, false,
     UINT8_MAX},
