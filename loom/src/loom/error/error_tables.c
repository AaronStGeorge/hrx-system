...
static const loom_error_def_t* const loom_all_error_defs[] = {
    ...
    &loom_err_parse_034,     &loom_err_bytecode_001,  &loom_err_bytecode_002,
    &loom_err_bytecode_003,  &loom_err_bytecode_004,  &loom_err_bytecode_005,
    &loom_err_bytecode_006,  &loom_err_bytecode_007,  &loom_err_bytecode_008,
    &loom_err_bytecode_009,  &loom_err_bytecode_010,  &loom_err_bytecode_011,
    &loom_err_bytecode_012,  &loom_err_bytecode_013,  &loom_err_bytecode_014,
    &loom_err_bytecode_015,  &loom_err_bytecode_016,  &loom_err_bytecode_017,
    &loom_err_fold_001,      &loom_err_fold_002,      &loom_err_fold_003,
    &loom_err_fold_004,      &loom_err_fold_005,      &loom_err_lowering_001,
    &loom_err_lowering_002,  &loom_err_lowering_003,  &loom_err_lowering_004,
    &loom_err_lowering_005,  &loom_err_lowering_006,  &loom_err_lowering_007,
    &loom_err_lowering_008,  &loom_err_lowering_009,  &loom_err_lowering_010,
    &loom_err_lowering_011,  &loom_err_lowering_012,  &loom_err_lowering_013,
    &loom_err_lowering_014,  &loom_err_lowering_015,  &loom_err_lowering_016,
    &loom_err_lowering_017,  &loom_err_lowering_018,  &loom_err_lowering_019,
    &loom_err_lowering_020,  &loom_err_lowering_021,  &loom_err_lowering_022,
    &loom_err_lowering_023,  &loom_err_lowering_024,  &loom_err_backend_001,
