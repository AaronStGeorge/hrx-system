...
static const loom_error_param_def_t loom_err_encoding_015_params[] = {
    {"op_name", LOOM_PARAM_STRING},
    {"key_name", LOOM_PARAM_STRING},
};
static const loom_error_def_t loom_err_encoding_015 = {
    .error_id = "ERR_ENCODING_015",
    .domain = LOOM_ERROR_DOMAIN_ENCODING,
    .severity = LOOM_DIAGNOSTIC_ERROR,
    .code = 15,
    .summary = "Unknown encoded auxiliary operand key.",
    .message_template =
        "{op_name} auxiliary operand key '{key_name}' is not supported",
    .fix_hint_template =
        "Use one of the encoded auxiliary keys understood by vector lowering",
    .param_defs = loom_err_encoding_015_params,
    .param_count = 2,
};

static const loom_error_param_def_t loom_err_encoding_016_params[] = {
    {"op_name", LOOM_PARAM_STRING},
    {"key_name", LOOM_PARAM_STRING},
};
static const loom_error_def_t loom_err_encoding_016 = {
    .error_id = "ERR_ENCODING_016",
    .domain = LOOM_ERROR_DOMAIN_ENCODING,
    .severity = LOOM_DIAGNOSTIC_ERROR,
    .code = 16,
    .summary = "Required encoded auxiliary operand is missing.",
    .message_template = "{op_name} auxiliary operands require key '{key_name}'",
    .fix_hint_template =
        "Provide the required SSA operand in the keyed auxiliary dictionary",
    .param_defs = loom_err_encoding_016_params,
    .param_count = 2,
};
...
static const loom_error_def_t* const loom_all_error_defs[] = {
    ...
    &loom_err_encoding_015,  &loom_err_encoding_016,  &loom_err_structure_001,
    ...
    &loom_err_structure_023, &loom_err_structure_024, &loom_err_structure_025,
    &loom_err_structure_026, &loom_err_structure_027, &loom_err_structure_028,
    &loom_err_structure_029, &loom_err_dominance_001, &loom_err_dominance_002,
    ...
    &loom_err_lowering_019,  &loom_err_backend_001,   &loom_err_backend_002,
