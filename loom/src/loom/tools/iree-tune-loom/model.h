...
// Shared iree-tune-loom run, benchmark, and HAL candidate model.

#ifndef LOOM_TOOLS_IREE_TUNE_LOOM_MODEL_H_
#define LOOM_TOOLS_IREE_TUNE_LOOM_MODEL_H_
...
#endif  // LOOM_TOOLS_IREE_TUNE_LOOM_MODEL_H_
