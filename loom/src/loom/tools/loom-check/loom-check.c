...
#ifndef LOOM_CHECK_HAVE_TARGET_AMDGPU
#define LOOM_CHECK_HAVE_TARGET_AMDGPU 0
#endif  // LOOM_CHECK_HAVE_TARGET_AMDGPU
...
#define LOOM_CHECK_HAVE_ANY_PROVIDER                                 \
  (LOOM_CHECK_HAVE_TARGET_AMDGPU || LOOM_CHECK_HAVE_TARGET_IREEVM || \
...
#if LOOM_CHECK_HAVE_TARGET_AMDGPU
