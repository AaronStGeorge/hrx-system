...
void iree_benchmark_loom_print_agents_md(FILE* file) {
  fprintf(
      ...
      "artifacts under `hal_executables/`. Debug JSONL compile and benchmark "
...
void iree_benchmark_loom_set_usage(const char* tool_name) {
  iree_flags_set_usage(
      ...
      "long sweeps. JSONL compile, profile, and static-summary payloads are "
      ...
      "executable artifacts under hal_executables/; compile and benchmark rows "
