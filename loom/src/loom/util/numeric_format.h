...
typedef enum loom_value_fact_numeric_format_bits_e {
  ...
  LOOM_VALUE_FACT_NUMERIC_FORMAT_F8_E4M3FNUZ = 1ull << 26,
  LOOM_VALUE_FACT_NUMERIC_FORMAT_F8_E5M2FNUZ = 1ull << 27,
  LOOM_VALUE_FACT_NUMERIC_FORMAT_F8_E8M0 = 1ull << 28,
  LOOM_VALUE_FACT_NUMERIC_FORMAT_BF8 = 1ull << 29,
  LOOM_VALUE_FACT_NUMERIC_FORMAT_F6_E3M2 = 1ull << 30,
  LOOM_VALUE_FACT_NUMERIC_FORMAT_F6_E2M3 = 1ull << 31,
  LOOM_VALUE_FACT_NUMERIC_FORMAT_BF6 = 1ull << 32,
  LOOM_VALUE_FACT_NUMERIC_FORMAT_F4_E2M1 = 1ull << 33,
  LOOM_VALUE_FACT_NUMERIC_FORMAT_TERNARY = 1ull << 34,
  LOOM_VALUE_FACT_NUMERIC_FORMAT_SIGN_BIT = 1ull << 35,
  LOOM_VALUE_FACT_NUMERIC_FORMAT_CODEBOOK_INDEX = 1ull << 36,
  LOOM_VALUE_FACT_NUMERIC_FORMAT_QUANT_I8 = 1ull << 37,
  LOOM_VALUE_FACT_NUMERIC_FORMAT_QUANT_I6 = 1ull << 38,
  LOOM_VALUE_FACT_NUMERIC_FORMAT_QUANT_I4 = 1ull << 39,
