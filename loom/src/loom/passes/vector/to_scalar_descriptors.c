...
static const loom_vector_to_scalar_descriptor_t kVectorToScalarDescriptors[] = {
    ...
    {LOOM_OP_VECTOR_ADDF, LOOM_OP_SCALAR_ADDF,
     LOOM_VECTOR_TO_SCALAR_LANE_GENERIC, 2, 0, LOOM_VECTOR_TO_SCALAR_INSTANCE_FLAG_MODE_FLOAT_ASSUMPTIONS, false, 0},
    ...
    {LOOM_OP_VECTOR_NEGF, LOOM_OP_SCALAR_NEGF,
     LOOM_VECTOR_TO_SCALAR_LANE_GENERIC, 1, 0, LOOM_VECTOR_TO_SCALAR_INSTANCE_FLAG_MODE_FLOAT_ASSUMPTIONS, false, UINT8_MAX},
    ...
    {LOOM_OP_VECTOR_FMAF, LOOM_OP_SCALAR_FMAF,
     LOOM_VECTOR_TO_SCALAR_LANE_GENERIC, 3, 0, LOOM_VECTOR_TO_SCALAR_INSTANCE_FLAG_MODE_FLOAT_ASSUMPTIONS, false, 2},
