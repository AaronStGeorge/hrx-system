...
LOOM_DEFINE_ATTR_STRING(loom_wasm_target_target_triple, 3)
LOOM_DEFINE_ATTR_STRING(loom_wasm_target_data_layout, 4)
LOOM_DEFINE_ATTR_ENUM_TYPED(loom_wasm_target_artifact_format, 5, loom_target_artifact_format_t)
LOOM_DEFINE_ATTR_STRING(loom_wasm_target_target_cpu, 6)
LOOM_DEFINE_ATTR_STRING(loom_wasm_target_target_features, 7)
LOOM_DEFINE_ATTR_I64(loom_wasm_target_default_pointer_bitwidth, 8)
LOOM_DEFINE_ATTR_I64(loom_wasm_target_index_bitwidth, 9)
LOOM_DEFINE_ATTR_I64(loom_wasm_target_offset_bitwidth, 10)
LOOM_DEFINE_ATTR_I64(loom_wasm_target_max_workgroup_size_x, 11)
LOOM_DEFINE_ATTR_I64(loom_wasm_target_max_workgroup_size_y, 12)
LOOM_DEFINE_ATTR_I64(loom_wasm_target_max_workgroup_size_z, 13)
LOOM_DEFINE_ATTR_I64(loom_wasm_target_max_flat_workgroup_size, 14)
LOOM_DEFINE_ATTR_I64(loom_wasm_target_subgroup_size, 15)
...
LOOM_DEFINE_ATTR_I64(loom_wasm_target_hal_binding_alignment, 29)
...
enum loom_wasm_target_build_flag_bits_e {
  ...
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_TARGET_TRIPLE = 1u << 1,
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_DATA_LAYOUT = 1u << 2,
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_ARTIFACT_FORMAT = 1u << 3,
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_TARGET_CPU = 1u << 4,
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_TARGET_FEATURES = 1u << 5,
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_DEFAULT_POINTER_BITWIDTH = 1u << 6,
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_INDEX_BITWIDTH = 1u << 7,
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_OFFSET_BITWIDTH = 1u << 8,
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_MAX_WORKGROUP_SIZE_X = 1u << 9,
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_MAX_WORKGROUP_SIZE_Y = 1u << 10,
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_MAX_WORKGROUP_SIZE_Z = 1u << 11,
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_MAX_FLAT_WORKGROUP_SIZE = 1u << 12,
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_SUBGROUP_SIZE = 1u << 13,
  ...
  LOOM_WASM_TARGET_BUILD_FLAG_HAS_HAL_BINDING_ALIGNMENT = 1u << 27,
