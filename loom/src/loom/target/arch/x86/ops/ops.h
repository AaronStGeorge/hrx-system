...
LOOM_DEFINE_ATTR_I64(loom_x86_target_hal_buffer_resource_flags, 25)
LOOM_DEFINE_ATTR_STRING(loom_x86_target_contract_set_key, 26)
LOOM_DEFINE_ATTR_I64(loom_x86_target_contract_feature_bits, 27)
enum loom_x86_target_build_flag_bits_e {
  ...
  LOOM_X86_TARGET_BUILD_FLAG_HAS_HAL_BUFFER_RESOURCE_FLAGS = 1u << 23,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_CONTRACT_SET_KEY = 1u << 24,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_CONTRACT_FEATURE_BITS = 1u << 25,
};
