...
LOOM_DEFINE_ATTR_I64(loom_x86_target_subgroup_size, 11)
LOOM_DEFINE_ATTR_I64(loom_x86_target_max_grid_size_x, 12)
LOOM_DEFINE_ATTR_I64(loom_x86_target_max_grid_size_y, 13)
LOOM_DEFINE_ATTR_I64(loom_x86_target_max_grid_size_z, 14)
LOOM_DEFINE_ATTR_I64(loom_x86_target_max_flat_grid_size, 15)
...
LOOM_DEFINE_ATTR_I64(loom_x86_target_hal_buffer_resource_flags, 29)
...
enum loom_x86_target_build_flag_bits_e {
  ...
  LOOM_X86_TARGET_BUILD_FLAG_HAS_SUBGROUP_SIZE = 1u << 9,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MAX_GRID_SIZE_X = 1u << 10,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MAX_GRID_SIZE_Y = 1u << 11,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MAX_GRID_SIZE_Z = 1u << 12,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MAX_FLAT_GRID_SIZE = 1u << 13,
  ...
  LOOM_X86_TARGET_BUILD_FLAG_HAS_HAL_BUFFER_RESOURCE_FLAGS = 1u << 27,
