...
LOOM_DEFINE_ATTR_I64(loom_x86_target_max_workgroup_count_x, 12)
LOOM_DEFINE_ATTR_I64(loom_x86_target_max_workgroup_count_y, 13)
LOOM_DEFINE_ATTR_I64(loom_x86_target_max_workgroup_count_z, 14)
LOOM_DEFINE_ATTR_I64(loom_x86_target_memory_space_generic, 15)
LOOM_DEFINE_ATTR_I64(loom_x86_target_memory_space_global, 16)
LOOM_DEFINE_ATTR_I64(loom_x86_target_memory_space_workgroup, 17)
LOOM_DEFINE_ATTR_I64(loom_x86_target_memory_space_constant, 18)
LOOM_DEFINE_ATTR_I64(loom_x86_target_memory_space_private, 19)
LOOM_DEFINE_ATTR_I64(loom_x86_target_memory_space_host, 20)
LOOM_DEFINE_ATTR_I64(loom_x86_target_memory_space_descriptor, 21)
LOOM_DEFINE_ATTR_ENUM_TYPED(loom_x86_target_abi, 22, loom_target_abi_kind_t)
LOOM_DEFINE_ATTR_STRING(loom_x86_target_export_symbol, 23)
LOOM_DEFINE_ATTR_ENUM_TYPED(loom_x86_target_linkage, 24, loom_target_linkage_t)
LOOM_DEFINE_ATTR_I64(loom_x86_target_hal_binding_alignment, 25)
LOOM_DEFINE_ATTR_I64(loom_x86_target_hal_buffer_resource_flags, 26)
LOOM_DEFINE_ATTR_STRING(loom_x86_target_contract_set_key, 27)
LOOM_DEFINE_ATTR_I64(loom_x86_target_contract_feature_bits, 28)
enum loom_x86_target_build_flag_bits_e {
  ...
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MAX_WORKGROUP_COUNT_X = 1u << 10,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MAX_WORKGROUP_COUNT_Y = 1u << 11,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MAX_WORKGROUP_COUNT_Z = 1u << 12,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_GENERIC = 1u << 13,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_GLOBAL = 1u << 14,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_WORKGROUP = 1u << 15,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_CONSTANT = 1u << 16,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_PRIVATE = 1u << 17,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_HOST = 1u << 18,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_MEMORY_SPACE_DESCRIPTOR = 1u << 19,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_ABI = 1u << 20,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_EXPORT_SYMBOL = 1u << 21,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_LINKAGE = 1u << 22,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_HAL_BINDING_ALIGNMENT = 1u << 23,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_HAL_BUFFER_RESOURCE_FLAGS = 1u << 24,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_CONTRACT_SET_KEY = 1u << 25,
  LOOM_X86_TARGET_BUILD_FLAG_HAS_CONTRACT_FEATURE_BITS = 1u << 26,
};
