...
static bool loom_x86_packed_dot_value_type(const loom_module_t* module,
...
static bool loom_x86_packed_dot_static_vector_element_count(
...
static bool loom_x86_packed_dot_assign_uint16(uint64_t value,
                                              uint16_t* out_value) {
...
static bool loom_x86_packed_dot_assign_scaled_uint16(uint64_t value,
                                                     uint64_t multiplier,
                                                     uint16_t* out_value) {
...
static bool loom_x86_packed_dot_derive_grouped_shape(
    uint64_t input_lane_count, uint64_t result_lane_count,
    uint64_t source_lane_bit_width, loom_x86_packed_dot_shape_t* out_shape) {
  *out_shape = (loom_x86_packed_dot_shape_t){0};
  if (result_lane_count == 0 || input_lane_count % result_lane_count != 0) {
    return false;
  }
  if (!loom_x86_packed_dot_assign_scaled_uint16(input_lane_count,
                                                source_lane_bit_width,
                                                &out_shape->vector_bit_width) ||
      !loom_x86_packed_dot_assign_uint16(input_lane_count,
                                         &out_shape->input_lane_count) ||
      !loom_x86_packed_dot_assign_uint16(result_lane_count,
                                         &out_shape->result_lane_count) ||
      !loom_x86_packed_dot_assign_uint16(input_lane_count / result_lane_count,
...
static bool loom_x86_packed_dot_static_grouped_shapes_match(
...
static bool loom_x86_packed_dot_scalar_numeric_type(
...
static bool loom_x86_packed_dot_dot4i_numeric_types(
    loom_vector_dot4i_kind_t kind,
    loom_x86_packed_dot_numeric_type_t* out_lhs_type,
    loom_x86_packed_dot_numeric_type_t* out_rhs_type) {
  *out_lhs_type = LOOM_X86_PACKED_DOT_NUMERIC_UNKNOWN;
  *out_rhs_type = LOOM_X86_PACKED_DOT_NUMERIC_UNKNOWN;
  switch (kind) {
    case LOOM_VECTOR_DOT4I_KIND_S8S8:
      *out_lhs_type = LOOM_X86_PACKED_DOT_NUMERIC_I8;
      *out_rhs_type = LOOM_X86_PACKED_DOT_NUMERIC_I8;
      return true;
    case LOOM_VECTOR_DOT4I_KIND_U8S8:
      *out_lhs_type = LOOM_X86_PACKED_DOT_NUMERIC_U8;
      *out_rhs_type = LOOM_X86_PACKED_DOT_NUMERIC_I8;
      return true;
    case LOOM_VECTOR_DOT4I_KIND_S8U8:
      *out_lhs_type = LOOM_X86_PACKED_DOT_NUMERIC_I8;
      *out_rhs_type = LOOM_X86_PACKED_DOT_NUMERIC_U8;
      return true;
...
static bool loom_x86_packed_dot_match_request_from_dot2f_op(
  ...
  if (!loom_x86_packed_dot_value_type(module, loom_vector_dot2f_lhs(op),
                                      &lhs_type) ||
      !loom_x86_packed_dot_value_type(module, loom_vector_dot2f_rhs(op),
                                      &rhs_type) ||
      !loom_x86_packed_dot_value_type(module, loom_vector_dot2f_acc(op),
                                      &acc_type) ||
      !loom_x86_packed_dot_value_type(module, loom_vector_dot2f_result(op),
                                      &result_type)) {
    return false;
  }

  loom_x86_packed_dot_numeric_type_t source_numeric_type =
      LOOM_X86_PACKED_DOT_NUMERIC_UNKNOWN;
  loom_x86_packed_dot_numeric_type_t rhs_numeric_type =
      LOOM_X86_PACKED_DOT_NUMERIC_UNKNOWN;
  loom_x86_packed_dot_numeric_type_t acc_numeric_type =
      LOOM_X86_PACKED_DOT_NUMERIC_UNKNOWN;
  loom_x86_packed_dot_numeric_type_t result_numeric_type =
      LOOM_X86_PACKED_DOT_NUMERIC_UNKNOWN;
  if (!loom_x86_packed_dot_scalar_numeric_type(loom_type_element_type(lhs_type),
                                               &source_numeric_type) ||
      !loom_x86_packed_dot_scalar_numeric_type(loom_type_element_type(rhs_type),
                                               &rhs_numeric_type) ||
      source_numeric_type != rhs_numeric_type ||
      !loom_x86_packed_dot_scalar_numeric_type(loom_type_element_type(acc_type),
                                               &acc_numeric_type) ||
      !loom_x86_packed_dot_scalar_numeric_type(
          loom_type_element_type(result_type), &result_numeric_type) ||
      acc_numeric_type != LOOM_X86_PACKED_DOT_NUMERIC_F32 ||
      result_numeric_type != LOOM_X86_PACKED_DOT_NUMERIC_F32 ||
      !loom_type_shape_equals(lhs_type, rhs_type) ||
      !loom_type_shape_equals(acc_type, result_type) ||
      !loom_x86_packed_dot_static_grouped_shapes_match(lhs_type, result_type,
                                                       2)) {
    return false;
  }
  ...
  if (!loom_x86_packed_dot_static_vector_element_count(lhs_type,
                                                       &input_lane_count) ||
      !loom_x86_packed_dot_static_vector_element_count(rhs_type,
                                                       &rhs_lane_count) ||
      !loom_x86_packed_dot_static_vector_element_count(result_type,
                                                       &result_lane_count) ||
      !loom_x86_packed_dot_static_vector_element_count(
  ...
  if (!loom_x86_packed_dot_derive_grouped_shape(
  ...
  out_request->accumulator_numeric_type = LOOM_X86_PACKED_DOT_NUMERIC_F32;
  out_request->result_numeric_type = LOOM_X86_PACKED_DOT_NUMERIC_F32;
  return true;
}

static bool loom_x86_packed_dot_match_request_from_dot4i_op(
    const loom_module_t* module, const loom_op_t* op,
    loom_x86_packed_dot_match_request_t* out_request) {
  ...
  loom_x86_packed_dot_numeric_type_t rhs_numeric_type =
      LOOM_X86_PACKED_DOT_NUMERIC_UNKNOWN;
  if (!loom_x86_packed_dot_dot4i_numeric_types(
  ...
  loom_type_t acc_type = loom_type_none();
  loom_type_t result_type = loom_type_none();
  if (!loom_x86_packed_dot_value_type(module, loom_vector_dot4i_lhs(op),
                                      &lhs_type) ||
      !loom_x86_packed_dot_value_type(module, loom_vector_dot4i_rhs(op),
                                      &rhs_type) ||
      !loom_x86_packed_dot_value_type(module, loom_vector_dot4i_acc(op),
                                      &acc_type) ||
      !loom_x86_packed_dot_value_type(module, loom_vector_dot4i_result(op),
                                      &result_type)) {
    return false;
  }
  ...
  out_request->accumulator_numeric_type = LOOM_X86_PACKED_DOT_NUMERIC_I32;
  out_request->result_numeric_type = LOOM_X86_PACKED_DOT_NUMERIC_I32;
  return true;
}
...
bool loom_x86_packed_dot_match_request_from_vector_op(
  ...
  *out_request = (loom_x86_packed_dot_match_request_t){0};
  ...
  if (loom_x86_packed_dot_match_request_from_dot2f_op(module, op, &request) ||
      loom_x86_packed_dot_match_request_from_dot4i_op(module, op, &request)) {
    *out_request = request;
    return true;
  }
  return false;
