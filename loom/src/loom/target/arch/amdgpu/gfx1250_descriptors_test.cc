...
TEST(AmdgpuDescriptorsTest, Gfx1250CoreDescriptorsExposeSemanticInvariants) {
  const loom_low_descriptor_set_t* descriptor_set =
      loom_amdgpu_gfx1250_core_descriptor_set();
  ...
  ExpectAmdgpuFlatAtomicDescriptors(
      descriptor_set, LOOM_AMDGPU_ENCODING_FORMAT_VFLAT, 24u,
      /*expected_offset_signed=*/true, /*expected_cache_immediate_count=*/2u,
