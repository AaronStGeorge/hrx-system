...
LOOM_DEFINE_ATTR_I64(loom_amdgpu_target_hal_binding_alignment, 25)
LOOM_DEFINE_ATTR_I64(loom_amdgpu_target_hal_buffer_resource_flags, 26)
LOOM_DEFINE_ATTR_STRING(loom_amdgpu_target_contract_set_key, 27)
LOOM_DEFINE_ATTR_I64(loom_amdgpu_target_contract_feature_bits, 28)
LOOM_DEFINE_ATTR_STRING(loom_amdgpu_target_processor, 29)
enum loom_amdgpu_target_build_flag_bits_e {
  ...
  LOOM_AMDGPU_TARGET_BUILD_FLAG_HAS_HAL_BINDING_ALIGNMENT = 1u << 23,
  LOOM_AMDGPU_TARGET_BUILD_FLAG_HAS_HAL_BUFFER_RESOURCE_FLAGS = 1u << 24,
  LOOM_AMDGPU_TARGET_BUILD_FLAG_HAS_CONTRACT_SET_KEY = 1u << 25,
  LOOM_AMDGPU_TARGET_BUILD_FLAG_HAS_CONTRACT_FEATURE_BITS = 1u << 26,
  LOOM_AMDGPU_TARGET_BUILD_FLAG_HAS_PROCESSOR = 1u << 27,
};
