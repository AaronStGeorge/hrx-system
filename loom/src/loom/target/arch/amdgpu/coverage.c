...
static const loom_target_coverage_row_t kLoomAmdgpuTargetCoverageRows[] = {
    LOOM_AMDGPU_GFX11_ROW(
        "vector.arithmetic", "i32-f32-vgpr", LOOM_AMDGPU_EXECUTABLE_LOW_PHASES,
        LOOM_AMDGPU_NATIVE_LOW_PHASES, "validation-run-provider-optional"),
    ...
    LOOM_AMDGPU_GFX11_ROW("memory.workgroup", "ds-b64-b96-read-write",
                          LOOM_AMDGPU_NATIVE_LOW_PHASES,
                          LOOM_TARGET_COVERAGE_PHASE_NONE,
                          "descriptor-workgroup-widths-missing"),
    ...
    LOOM_AMDGPU_GFX1250_ROW(
        ...
        LOOM_AMDGPU_NATIVE_LOW_PHASES, LOOM_TARGET_COVERAGE_PHASE_NONE,
        "descriptor-workgroup-addressing-missing"),
    LOOM_AMDGPU_GFX950_ROW(
        "memory.workgroup", "ds-read2-write2-stride64-addtid",
        LOOM_AMDGPU_NATIVE_LOW_PHASES, LOOM_TARGET_COVERAGE_PHASE_NONE,
    ...
    LOOM_AMDGPU_GFX950_ROW(
        "memory.transpose", "ds-read-tr", LOOM_AMDGPU_NATIVE_LOW_PHASES,
        LOOM_TARGET_COVERAGE_PHASE_NONE, "descriptor-transpose-load-missing"),
    ...
    LOOM_AMDGPU_GFX11_ROW(
        ...
        LOOM_AMDGPU_NATIVE_LOW_PHASES, LOOM_AMDGPU_AUTHORED_LOW_PHASES,
        "source-lower-barrier-missing"),
    LOOM_AMDGPU_GFX12_ROW(
        "synchronization", "split-loadcnt-storecnt-alu-workgroup-barrier",
        LOOM_AMDGPU_NATIVE_LOW_PHASES, LOOM_AMDGPU_AUTHORED_LOW_PHASES,
        "source-lower-barrier-missing"),
    LOOM_AMDGPU_GFX1250_ROW(
        "synchronization", "split-loadcnt-storecnt-alu-workgroup-barrier",
        ...
        "source-lower-barrier-missing"),
    LOOM_AMDGPU_GFX950_ROW(
        "synchronization", "combined-waitcnt-workgroup-barrier",
        LOOM_AMDGPU_NATIVE_LOW_PHASES, LOOM_AMDGPU_AUTHORED_LOW_PHASES,
        "source-lower-barrier-missing"),
