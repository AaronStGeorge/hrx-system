...
static const loom_target_coverage_row_t kLoomAmdgpuTargetCoverageRows[] = {
    ...
    LOOM_AMDGPU_GFX950_ROW("memory.cache", "cache-policy-invalidate",
                           ...
                           LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                           "source-lower-cache-policy-missing"),
    LOOM_AMDGPU_GFX11_ROW("memory.cache", "cache-swizzle-prefetch",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_TARGET_COVERAGE_PHASE_NONE,
                          "descriptor-prefetch-swizzle-missing"),
    LOOM_AMDGPU_GFX12_ROW("memory.cache", "cache-swizzle-prefetch",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_TARGET_COVERAGE_PHASE_NONE,
                          "descriptor-prefetch-swizzle-missing"),
    LOOM_AMDGPU_GFX1250_ROW("memory.cache", "cache-swizzle-prefetch",
                            LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                            LOOM_TARGET_COVERAGE_PHASE_NONE,
                            "descriptor-prefetch-swizzle-missing"),
    LOOM_AMDGPU_GFX950_ROW("memory.cache", "cache-swizzle-prefetch",
                           LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                           LOOM_TARGET_COVERAGE_PHASE_NONE,
                           "descriptor-prefetch-swizzle-missing"),
