...
#define LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES \
...
static const loom_target_coverage_row_t kLoomAmdgpuTargetCoverageRows[] = {
    ...
    LOOM_AMDGPU_GFX11_ROW("vector.reduction", "horizontal-i32-f32-vgpr",
                          LOOM_AMDGPU_EXPECTED_EXECUTABLE_LOW_PHASES,
                          LOOM_AMDGPU_NATIVE_LOW_GFX11_PHASES,
                          "validation-run-provider-optional"),
    LOOM_AMDGPU_GFX12_ROW("vector.reduction", "horizontal-i32-f32-vgpr",
                          LOOM_AMDGPU_EXPECTED_EXECUTABLE_LOW_PHASES,
                          LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                          "artifact-wrap-validation-missing"),
    LOOM_AMDGPU_GFX1250_ROW("vector.reduction", "horizontal-i32-f32-vgpr",
                            LOOM_AMDGPU_EXPECTED_EXECUTABLE_LOW_PHASES,
                            LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                            "artifact-wrap-validation-missing"),
    LOOM_AMDGPU_GFX950_ROW("vector.reduction", "horizontal-i32-f32-vgpr",
                           LOOM_AMDGPU_EXPECTED_EXECUTABLE_LOW_PHASES,
                           LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                           "artifact-wrap-validation-missing"),

    LOOM_AMDGPU_GFX11_ROW("vector.decode", "bitfield-i32-vgpr",
                          LOOM_AMDGPU_EXPECTED_EXECUTABLE_LOW_PHASES,
                          LOOM_AMDGPU_NATIVE_LOW_GFX11_PHASES,
                          "validation-run-provider-optional"),
    LOOM_AMDGPU_GFX12_ROW("vector.decode", "bitfield-i32-vgpr",
                          LOOM_AMDGPU_EXPECTED_EXECUTABLE_LOW_PHASES,
                          LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                          "artifact-wrap-validation-missing"),
    LOOM_AMDGPU_GFX1250_ROW("vector.decode", "bitfield-i32-vgpr",
                            LOOM_AMDGPU_EXPECTED_EXECUTABLE_LOW_PHASES,
                            LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                            "artifact-wrap-validation-missing"),
    LOOM_AMDGPU_GFX950_ROW("vector.decode", "bitfield-i32-vgpr",
                           LOOM_AMDGPU_EXPECTED_EXECUTABLE_LOW_PHASES,
                           LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                           "artifact-wrap-validation-missing"),

    LOOM_AMDGPU_GFX11_ROW("vector.dot", "dot4i-s8s8-vgpr",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                          "artifact-wrap-validation-missing"),
    LOOM_AMDGPU_GFX12_ROW("vector.dot", "dot4i-s8s8-vgpr",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                          "artifact-wrap-validation-missing"),
    LOOM_AMDGPU_GFX1250_ROW("vector.dot", "dot4i-s8s8-vgpr",
                            LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                            LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                            "artifact-wrap-validation-missing"),
    LOOM_AMDGPU_GFX950_ROW("vector.dot", "dot4i-s8s8-vgpr",
                           LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                           LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                           "artifact-wrap-validation-missing"),
    LOOM_AMDGPU_GFX11_ROW("vector.dot", "dot4i-u8u8-vgpr",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                          "artifact-wrap-validation-missing"),
    LOOM_AMDGPU_GFX12_ROW("vector.dot", "dot4i-u8u8-vgpr",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                          "artifact-wrap-validation-missing"),
    LOOM_AMDGPU_GFX1250_ROW("vector.dot", "dot4i-u8u8-vgpr",
                            LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                            LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                            "artifact-wrap-validation-missing"),
    LOOM_AMDGPU_GFX950_ROW("vector.dot", "dot4i-u8u8-vgpr",
                           LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                           LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                           "artifact-wrap-validation-missing"),
    ...
    LOOM_AMDGPU_GFX12_ROW("memory.workgroup", "ds-b32-b128-load-store",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                          "source-lower-validation-missing"),
    ...
    LOOM_AMDGPU_GFX11_ROW("memory.workgroup", "ds-read2-write2-stride64",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_NATIVE_LOW_GFX11_PHASES, ""),
    LOOM_AMDGPU_GFX12_ROW("memory.workgroup", "ds-read2-write2-stride64",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                          "artifact-wrap-validation-missing"),
    LOOM_AMDGPU_GFX1250_ROW("memory.workgroup", "ds-read2-write2-stride64",
                            LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                            LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                            "artifact-wrap-validation-missing"),
    LOOM_AMDGPU_GFX950_ROW("memory.workgroup", "ds-read2-write2-stride64",
                           LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                           LOOM_AMDGPU_NATIVE_LOW_BINARY_PHASES,
                           "artifact-wrap-validation-missing"),
    ...
    LOOM_AMDGPU_GFX11_ROW("memory.diagnostics", "lds-bank-conflict-remarks",
                          LOOM_TARGET_COVERAGE_PHASE_SOURCE_LOWER,
                          LOOM_TARGET_COVERAGE_PHASE_SOURCE_LOWER, ""),
    LOOM_AMDGPU_GFX12_ROW("memory.diagnostics", "lds-bank-conflict-remarks",
                          LOOM_TARGET_COVERAGE_PHASE_SOURCE_LOWER,
                          LOOM_TARGET_COVERAGE_PHASE_SOURCE_LOWER, ""),
    LOOM_AMDGPU_GFX1250_ROW("memory.diagnostics", "lds-bank-conflict-remarks",
                            LOOM_TARGET_COVERAGE_PHASE_SOURCE_LOWER,
                            LOOM_TARGET_COVERAGE_PHASE_SOURCE_LOWER, ""),
    LOOM_AMDGPU_GFX950_ROW("memory.diagnostics", "lds-bank-conflict-remarks",
                           LOOM_TARGET_COVERAGE_PHASE_SOURCE_LOWER,
                           LOOM_TARGET_COVERAGE_PHASE_SOURCE_LOWER, ""),
    ...
    LOOM_AMDGPU_GFX11_ROW("memory.crosslane", "ds-permute-bpermute-swizzle",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                          "source-lower-crosslane-missing"),
    ...
    LOOM_AMDGPU_GFX950_ROW("memory.transpose", "ds-read-tr",
                           LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                           LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                           "source-lower-transpose-missing"),

    LOOM_AMDGPU_GFX11_ROW("memory.cache", "cache-policy-invalidate",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                          "source-lower-cache-policy-missing"),
    LOOM_AMDGPU_GFX12_ROW("memory.cache", "cache-policy-invalidate",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                          "source-lower-cache-policy-missing"),
    LOOM_AMDGPU_GFX1250_ROW("memory.cache", "cache-policy-invalidate",
                            LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                            LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                            "source-lower-cache-policy-missing"),
    LOOM_AMDGPU_GFX950_ROW("memory.cache", "cache-policy-invalidate",
                           LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                           LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                           "source-lower-cache-policy-missing"),
    LOOM_AMDGPU_GFX11_ROW("memory.cache", "instruction-prefetch-control",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                          "source-lower-cache-prefetch-missing"),
    LOOM_AMDGPU_GFX12_ROW("memory.cache", "scalar-data-inst-prefetch",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                          "source-lower-cache-prefetch-missing"),
    LOOM_AMDGPU_GFX1250_ROW("memory.cache", "scalar-data-inst-prefetch",
                            LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                            LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                            "source-lower-cache-prefetch-missing"),
    LOOM_AMDGPU_GFX950_ROW("memory.cache", "data-cache-discard",
                           LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                           LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                           "source-lower-cache-policy-missing"),
    ...
    LOOM_AMDGPU_GFX11_ROW("matrix.contract", "wmma",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                          "source-lower-matrix-artifact-wrap-missing"),
    LOOM_AMDGPU_GFX12_ROW("matrix.contract", "wmma",
                          LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                          LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                          "source-lower-matrix-artifact-wrap-missing"),
    LOOM_AMDGPU_GFX1250_ROW("matrix.contract", "wmma",
                            LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                            LOOM_AMDGPU_AUTHORED_LOW_BINARY_PHASES,
                            "source-lower-matrix-artifact-wrap-missing"),
    LOOM_AMDGPU_GFX1250_ROW("matrix.contract", "swmmac-scale",
                            LOOM_AMDGPU_EXPECTED_NATIVE_LOW_PHASES,
                            LOOM_AMDGPU_MATRIX_DESCRIPTOR_PHASES,
                            "supplemental-matrix-encoding-missing"),
