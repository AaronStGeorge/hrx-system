...
#define LOOM_AMDGPU_COMPARE_GUARDS(predicate, descriptor)                  \
...
enum loom_amdgpu_compare_rule_e {
  ...
  LOOM_AMDGPU_COMPARE_RULE_COUNT_ = 10,
};
...
#undef LOOM_AMDGPU_COMPARE_GUARDS
...
#define LOOM_AMDGPU_COMPARE_EMIT(descriptor)             \
  {                                                      \
      .kind = LOOM_LOW_LOWER_EMIT_DESCRIPTOR_OP,         \
      .descriptor_id = descriptor,                       \
      .operand_ref_start = LOOM_AMDGPU_COMPARE_OPERAND0, \
      .operand_ref_count = 2,                            \
...
static const loom_low_lower_emit_t kAmdgpuCompareEmits[] = {
    [LOOM_AMDGPU_COMPARE_RULE_EQ] =
        LOOM_AMDGPU_COMPARE_EMIT(LOOM_AMDGPU_DESCRIPTOR_ID_S_CMP_EQ_I32),
    [LOOM_AMDGPU_COMPARE_RULE_NE] =
        LOOM_AMDGPU_COMPARE_EMIT(LOOM_AMDGPU_DESCRIPTOR_ID_S_CMP_LG_I32),
    [LOOM_AMDGPU_COMPARE_RULE_SLT] =
        LOOM_AMDGPU_COMPARE_EMIT(LOOM_AMDGPU_DESCRIPTOR_ID_S_CMP_LT_I32),
    [LOOM_AMDGPU_COMPARE_RULE_SLE] =
        LOOM_AMDGPU_COMPARE_EMIT(LOOM_AMDGPU_DESCRIPTOR_ID_S_CMP_LE_I32),
    [LOOM_AMDGPU_COMPARE_RULE_SGT] =
        LOOM_AMDGPU_COMPARE_EMIT(LOOM_AMDGPU_DESCRIPTOR_ID_S_CMP_GT_I32),
    [LOOM_AMDGPU_COMPARE_RULE_SGE] =
        LOOM_AMDGPU_COMPARE_EMIT(LOOM_AMDGPU_DESCRIPTOR_ID_S_CMP_GE_I32),
    [LOOM_AMDGPU_COMPARE_RULE_ULT] =
        LOOM_AMDGPU_COMPARE_EMIT(LOOM_AMDGPU_DESCRIPTOR_ID_S_CMP_LT_U32),
    [LOOM_AMDGPU_COMPARE_RULE_ULE] =
        LOOM_AMDGPU_COMPARE_EMIT(LOOM_AMDGPU_DESCRIPTOR_ID_S_CMP_LE_U32),
    [LOOM_AMDGPU_COMPARE_RULE_UGT] =
        LOOM_AMDGPU_COMPARE_EMIT(LOOM_AMDGPU_DESCRIPTOR_ID_S_CMP_GT_U32),
    [LOOM_AMDGPU_COMPARE_RULE_UGE] =
        LOOM_AMDGPU_COMPARE_EMIT(LOOM_AMDGPU_DESCRIPTOR_ID_S_CMP_GE_U32),
};
