...
static const loom_amdgpu_lower_dispatch_row_t kAmdgpuLowerDispatchRows[] = {
    ...
    LOOM_AMDGPU_DIRECT_ROW(LOOM_OP_KERNEL_WORKGROUP_ID,
                           ...
                           loom_amdgpu_emit_preamble_dispatch,
                           loom_amdgpu_low_legality_verify_kernel_preamble),
    LOOM_AMDGPU_DIRECT_ROW(LOOM_OP_KERNEL_WORKGROUP_SIZE,
                           loom_amdgpu_select_preamble_dispatch,
                           loom_amdgpu_emit_preamble_dispatch,
                           loom_amdgpu_low_legality_verify_kernel_preamble),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_WORKGROUP_COUNT,
                             loom_amdgpu_low_legality_verify_kernel_preamble),
    LOOM_AMDGPU_DIRECT_ROW(LOOM_OP_KERNEL_WORKITEM_DISPATCH_ID,
                           loom_amdgpu_select_preamble_dispatch,
                           loom_amdgpu_emit_preamble_dispatch,
                           loom_amdgpu_low_legality_verify_kernel_preamble),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_ID,
                             loom_amdgpu_low_legality_verify_kernel_preamble),
    LOOM_AMDGPU_DIRECT_ROW(LOOM_OP_KERNEL_SUBGROUP_COUNT,
                           loom_amdgpu_select_preamble_dispatch,
                           loom_amdgpu_emit_preamble_dispatch,
                           loom_amdgpu_low_legality_verify_kernel_preamble),
    LOOM_AMDGPU_DIRECT_ROW(LOOM_OP_KERNEL_SUBGROUP_SIZE,
                           loom_amdgpu_select_preamble_dispatch,
                           loom_amdgpu_emit_preamble_dispatch,
                           loom_amdgpu_low_legality_verify_kernel_preamble),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_LANE_ID,
                             loom_amdgpu_low_legality_verify_kernel_preamble),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_SHUFFLE,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_BROADCAST,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_BROADCAST_FIRST,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_REDUCE,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_SCAN,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_VOTE_ANY,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_VOTE_ALL,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_VOTE_BALLOT,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_ACTIVE_MASK,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_MATCH_ANY,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_MATCH_ALL,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_WORKGROUP_REDUCE,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_WORKGROUP_VOTE_ANY,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_WORKGROUP_VOTE_ALL,
                             loom_amdgpu_low_legality_verify_kernel_collective),
    LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_WORKGROUP_VOTE_COUNT,
                             loom_amdgpu_low_legality_verify_kernel_collective),
