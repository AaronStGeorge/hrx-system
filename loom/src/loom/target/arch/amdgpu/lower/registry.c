...
static const loom_amdgpu_lower_dispatch_row_t kAmdgpuLowerDispatchRows[] = {
  ...
  LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_ID, loom_amdgpu_low_legality_verify_kernel_preamble),
  ...
  LOOM_AMDGPU_LEGALITY_ROW(LOOM_OP_KERNEL_SUBGROUP_LANE_ID, loom_amdgpu_low_legality_verify_kernel_preamble),
