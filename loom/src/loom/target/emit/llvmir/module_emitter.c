...
static const loom_llvmir_emit_compare_info_t kCompareInfos[] = {
    ...
    LOOM_LLVMIR_VECTOR_COMPARE_INFOS(2), LOOM_LLVMIR_VECTOR_COMPARE_INFOS(4),
    LOOM_LLVMIR_VECTOR_COMPARE_INFOS(8), LOOM_LLVMIR_VECTOR_COMPARE_INFOS(16),
};
...
static const uint32_t kSelectDescriptorRefs[] = {
    ...
    LOOM_LLVMIR_VECTOR_SELECT_REFS(2), LOOM_LLVMIR_VECTOR_SELECT_REFS(4),
