...
static const loom_attr_descriptor_t loom_ireevm_target_attr_desc[] = {
    ...
    {_BSTRING(13, "target_triple"), LOOM_ATTR_STRING, LOOM_ATTR_OPTIONAL, 0, NULL, NULL},
    {_BSTRING(11, "data_layout"), LOOM_ATTR_STRING, LOOM_ATTR_OPTIONAL, 0, NULL, NULL},
    ...
    {_BSTRING(10, "target_cpu"), LOOM_ATTR_STRING, LOOM_ATTR_OPTIONAL, 0, NULL, NULL},
    {_BSTRING(15, "target_features"), LOOM_ATTR_STRING, LOOM_ATTR_OPTIONAL, 0, NULL, NULL},
...
static const loom_target_projection_t loom_ireevm_target_target_projections[] = {
    ...
    {offsetof(loom_target_bundle_storage_t, snapshot.target_triple), 3, LOOM_TARGET_PROJECTION_VALUE_STRING_VIEW},
    {offsetof(loom_target_bundle_storage_t, snapshot.data_layout), 4, LOOM_TARGET_PROJECTION_VALUE_STRING_VIEW},
    {offsetof(loom_target_bundle_storage_t, snapshot.artifact_format), 5, LOOM_TARGET_PROJECTION_VALUE_ENUM_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.target_cpu), 6, LOOM_TARGET_PROJECTION_VALUE_STRING_VIEW},
    {offsetof(loom_target_bundle_storage_t, snapshot.target_features), 7, LOOM_TARGET_PROJECTION_VALUE_STRING_VIEW},
    {offsetof(loom_target_bundle_storage_t, snapshot.default_pointer_bitwidth), 8, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.index_bitwidth), 9, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.offset_bitwidth), 10, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.max_workgroup_size.x), 11, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.max_workgroup_size.y), 12, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.max_workgroup_size.z), 13, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.max_flat_workgroup_size), 14, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.subgroup_size), 15, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.max_workgroup_count.x), 16, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.max_workgroup_count.y), 17, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.max_workgroup_count.z), 18, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.memory_spaces.generic), 19, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.memory_spaces.global), 20, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.memory_spaces.workgroup), 21, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.memory_spaces.constant), 22, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.memory_spaces.private_memory), 23, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.memory_spaces.host), 24, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, snapshot.memory_spaces.descriptor), 25, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, export_plan.abi_kind), 26, LOOM_TARGET_PROJECTION_VALUE_ENUM_U32},
    {offsetof(loom_target_bundle_storage_t, export_plan.export_symbol), 27, LOOM_TARGET_PROJECTION_VALUE_STRING_VIEW},
    {offsetof(loom_target_bundle_storage_t, export_plan.linkage), 28, LOOM_TARGET_PROJECTION_VALUE_ENUM_U32},
    {offsetof(loom_target_bundle_storage_t, export_plan.hal_kernel.binding_alignment), 29, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, export_plan.hal_kernel.buffer_resource_flags), 30, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U32},
    {offsetof(loom_target_bundle_storage_t, config.contract_set_key), 31, LOOM_TARGET_PROJECTION_VALUE_STRING_VIEW},
    {offsetof(loom_target_bundle_storage_t, config.contract_feature_bits), 32, LOOM_TARGET_PROJECTION_VALUE_I64_TO_U64},
};
