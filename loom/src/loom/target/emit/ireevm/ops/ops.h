...
LOOM_DEFINE_ATTR_STRING(loom_ireevm_target_target_triple, 3)
LOOM_DEFINE_ATTR_STRING(loom_ireevm_target_data_layout, 4)
LOOM_DEFINE_ATTR_ENUM_TYPED(loom_ireevm_target_artifact_format, 5, loom_target_artifact_format_t)
LOOM_DEFINE_ATTR_STRING(loom_ireevm_target_target_cpu, 6)
LOOM_DEFINE_ATTR_STRING(loom_ireevm_target_target_features, 7)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_default_pointer_bitwidth, 8)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_index_bitwidth, 9)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_offset_bitwidth, 10)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_max_workgroup_size_x, 11)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_max_workgroup_size_y, 12)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_max_workgroup_size_z, 13)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_max_flat_workgroup_size, 14)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_subgroup_size, 15)
...
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_hal_binding_alignment, 29)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_hal_buffer_resource_flags, 30)
LOOM_DEFINE_ATTR_STRING(loom_ireevm_target_contract_set_key, 31)
LOOM_DEFINE_ATTR_I64(loom_ireevm_target_contract_feature_bits, 32)
enum loom_ireevm_target_build_flag_bits_e {
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_CODEGEN_FORMAT = 1u << 0,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_TARGET_TRIPLE = 1u << 1,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_DATA_LAYOUT = 1u << 2,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_ARTIFACT_FORMAT = 1u << 3,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_TARGET_CPU = 1u << 4,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_TARGET_FEATURES = 1u << 5,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_DEFAULT_POINTER_BITWIDTH = 1u << 6,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_INDEX_BITWIDTH = 1u << 7,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_OFFSET_BITWIDTH = 1u << 8,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MAX_WORKGROUP_SIZE_X = 1u << 9,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MAX_WORKGROUP_SIZE_Y = 1u << 10,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MAX_WORKGROUP_SIZE_Z = 1u << 11,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_MAX_FLAT_WORKGROUP_SIZE = 1u << 12,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_SUBGROUP_SIZE = 1u << 13,
  ...
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_HAL_BINDING_ALIGNMENT = 1u << 27,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_HAL_BUFFER_RESOURCE_FLAGS = 1u << 28,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_CONTRACT_SET_KEY = 1u << 29,
  LOOM_IREEVM_TARGET_BUILD_FLAG_HAS_CONTRACT_FEATURE_BITS = 1u << 30,
};
