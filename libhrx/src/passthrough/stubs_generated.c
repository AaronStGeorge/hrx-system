...
#define DEFINE_STUB(name)                                   \
  __attribute__((visibility("default"))) void* name(void) { \
    ...
    if (!real_fn) real_fn = get_real_sym(#name);            \
    if (!real_fn) {                                         \
...
__asm__(
    ".symver hipBindTextureToMipmappedArray, "
    "hipBindTextureToMipmappedArray@hip_4.2");
...
__asm__(
    ".symver hipDeviceGetGraphMemAttribute, "
    "hipDeviceGetGraphMemAttribute@hip_4.5");
...
__asm__(
    ".symver hipDeviceGetStreamPriorityRange, "
    "hipDeviceGetStreamPriorityRange@hip_4.2");
...
__asm__(
    ".symver hipDeviceGetTexture1DLinearMaxWidth, "
    "hipDeviceGetTexture1DLinearMaxWidth@hip_4.2");
...
__asm__(
    ".symver hipDeviceSetGraphMemAttribute, "
    "hipDeviceSetGraphMemAttribute@hip_4.5");
...
__asm__(
    ".symver hipDrvGraphExecMemcpyNodeSetParams, "
    "hipDrvGraphExecMemcpyNodeSetParams@hip_6.2");
...
__asm__(
    ".symver hipDrvGraphExecMemsetNodeSetParams, "
    "hipDrvGraphExecMemsetNodeSetParams@hip_6.2");
...
__asm__(
    ".symver hipDrvGraphMemcpyNodeGetParams, "
    "hipDrvGraphMemcpyNodeGetParams@hip_6.0");
...
__asm__(
    ".symver hipDrvGraphMemcpyNodeSetParams, "
    "hipDrvGraphMemcpyNodeSetParams@hip_6.0");
...
__asm__(
    ".symver hipExtGetLinkTypeAndHopCount, "
    "hipExtGetLinkTypeAndHopCount@hip_4.2");
...
__asm__(
    ".symver hipExtLaunchMultiKernelMultiDevice, "
    "hipExtLaunchMultiKernelMultiDevice@hip_4.2");
...
__asm__(
    ".symver hipExtStreamCreateWithCUMask, "
    "hipExtStreamCreateWithCUMask@hip_4.2");
...
__asm__(
    ".symver hipExternalMemoryGetMappedBuffer, "
    "hipExternalMemoryGetMappedBuffer@hip_4.3");
...
__asm__(
    ".symver hipGetTextureAlignmentOffset, "
    "hipGetTextureAlignmentOffset@hip_4.2");
...
__asm__(
    ".symver hipGetTextureObjectResourceDesc, "
    "hipGetTextureObjectResourceDesc@hip_4.2");
...
__asm__(
    ".symver hipGetTextureObjectResourceViewDesc, "
    "hipGetTextureObjectResourceViewDesc@hip_4.2");
...
__asm__(
    ".symver hipGetTextureObjectTextureDesc, "
    "hipGetTextureObjectTextureDesc@hip_4.2");
...
__asm__(
    ".symver hipGraphAddExternalSemaphoresSignalNode, "
    "hipGraphAddExternalSemaphoresSignalNode@hip_5.3");
...
__asm__(
    ".symver hipGraphAddExternalSemaphoresWaitNode, "
    "hipGraphAddExternalSemaphoresWaitNode@hip_5.3");
...
__asm__(
    ".symver hipGraphAddMemcpyNodeFromSymbol, "
    "hipGraphAddMemcpyNodeFromSymbol@hip_4.5");
...
__asm__(
    ".symver hipGraphAddMemcpyNodeToSymbol, "
    "hipGraphAddMemcpyNodeToSymbol@hip_4.5");
...
__asm__(
    ".symver hipGraphBatchMemOpNodeGetParams, "
    "hipGraphBatchMemOpNodeGetParams@hip_6.4");
...
__asm__(
    ".symver hipGraphBatchMemOpNodeSetParams, "
    "hipGraphBatchMemOpNodeSetParams@hip_6.4");
...
__asm__(
    ".symver hipGraphChildGraphNodeGetGraph, "
    "hipGraphChildGraphNodeGetGraph@hip_4.5");
...
__asm__(
    ".symver hipGraphEventRecordNodeGetEvent, "
    "hipGraphEventRecordNodeGetEvent@hip_4.5");
...
__asm__(
    ".symver hipGraphEventRecordNodeSetEvent, "
    "hipGraphEventRecordNodeSetEvent@hip_4.5");
...
__asm__(
    ".symver hipGraphEventWaitNodeGetEvent, "
    "hipGraphEventWaitNodeGetEvent@hip_4.5");
...
__asm__(
    ".symver hipGraphEventWaitNodeSetEvent, "
    "hipGraphEventWaitNodeSetEvent@hip_4.5");
...
__asm__(
    ".symver hipGraphExecBatchMemOpNodeSetParams, "
    "hipGraphExecBatchMemOpNodeSetParams@hip_6.4");
...
__asm__(
    ".symver hipGraphExecChildGraphNodeSetParams, "
    "hipGraphExecChildGraphNodeSetParams@hip_4.5");
...
__asm__(
    ".symver hipGraphExecEventRecordNodeSetEvent, "
    "hipGraphExecEventRecordNodeSetEvent@hip_4.5");
...
__asm__(
    ".symver hipGraphExecEventWaitNodeSetEvent, "
    "hipGraphExecEventWaitNodeSetEvent@hip_4.5");
...
__asm__(
    ".symver hipGraphExecExternalSemaphoresSignalNodeSetParams, "
    "hipGraphExecExternalSemaphoresSignalNodeSetParams@hip_5.3");
...
__asm__(
    ".symver hipGraphExecExternalSemaphoresWaitNodeSetParams, "
    "hipGraphExecExternalSemaphoresWaitNodeSetParams@hip_5.3");
...
__asm__(
    ".symver hipGraphExecHostNodeSetParams, "
    "hipGraphExecHostNodeSetParams@hip_4.5");
...
__asm__(
    ".symver hipGraphExecKernelNodeSetParams, "
    "hipGraphExecKernelNodeSetParams@hip_4.4");
...
__asm__(
    ".symver hipGraphExecMemcpyNodeSetParams, "
    "hipGraphExecMemcpyNodeSetParams@hip_4.5");
...
__asm__(
    ".symver hipGraphExecMemcpyNodeSetParams1D, "
    "hipGraphExecMemcpyNodeSetParams1D@hip_4.5");
...
__asm__(
    ".symver hipGraphExecMemcpyNodeSetParamsFromSymbol, "
    "hipGraphExecMemcpyNodeSetParamsFromSymbol@hip_4.5");
...
__asm__(
    ".symver hipGraphExecMemcpyNodeSetParamsToSymbol, "
    "hipGraphExecMemcpyNodeSetParamsToSymbol@hip_4.5");
...
__asm__(
    ".symver hipGraphExecMemsetNodeSetParams, "
    "hipGraphExecMemsetNodeSetParams@hip_4.5");
...
__asm__(
    ".symver hipGraphExternalSemaphoresSignalNodeGetParams, "
    "hipGraphExternalSemaphoresSignalNodeGetParams@hip_5.3");
...
__asm__(
    ".symver hipGraphExternalSemaphoresSignalNodeSetParams, "
    "hipGraphExternalSemaphoresSignalNodeSetParams@hip_5.3");
...
__asm__(
    ".symver hipGraphExternalSemaphoresWaitNodeGetParams, "
    "hipGraphExternalSemaphoresWaitNodeGetParams@hip_5.3");
...
__asm__(
    ".symver hipGraphExternalSemaphoresWaitNodeSetParams, "
    "hipGraphExternalSemaphoresWaitNodeSetParams@hip_5.3");
...
__asm__(
    ".symver hipGraphInstantiateWithFlags, "
    "hipGraphInstantiateWithFlags@hip_4.5");
...
__asm__(
    ".symver hipGraphInstantiateWithParams, "
    "hipGraphInstantiateWithParams@hip_6.1");
...
__asm__(
    ".symver hipGraphKernelNodeCopyAttributes, "
    "hipGraphKernelNodeCopyAttributes@hip_5.3");
...
__asm__(
    ".symver hipGraphKernelNodeGetAttribute, "
    "hipGraphKernelNodeGetAttribute@hip_5.0");
...
__asm__(
    ".symver hipGraphKernelNodeSetAttribute, "
    "hipGraphKernelNodeSetAttribute@hip_5.0");
...
__asm__(
    ".symver hipGraphMemAllocNodeGetParams, "
    "hipGraphMemAllocNodeGetParams@hip_5.5");
...
__asm__(
    ".symver hipGraphMemFreeNodeGetParams, "
    "hipGraphMemFreeNodeGetParams@hip_5.5");
...
__asm__(
    ".symver hipGraphMemcpyNodeSetParams1D, "
    "hipGraphMemcpyNodeSetParams1D@hip_4.5");
...
__asm__(
    ".symver hipGraphMemcpyNodeSetParamsFromSymbol, "
    "hipGraphMemcpyNodeSetParamsFromSymbol@hip_4.5");
...
__asm__(
    ".symver hipGraphMemcpyNodeSetParamsToSymbol, "
    "hipGraphMemcpyNodeSetParamsToSymbol@hip_4.5");
...
__asm__(
    ".symver hipGraphNodeGetDependentNodes, "
    "hipGraphNodeGetDependentNodes@hip_4.5");
...
__asm__(
    ".symver hipGraphicsResourceGetMappedPointer, "
    "hipGraphicsResourceGetMappedPointer@hip_4.3");
...
__asm__(
    ".symver hipGraphicsSubResourceGetMappedArray, "
    "hipGraphicsSubResourceGetMappedArray@hip_4.5");
...
__asm__(
    ".symver hipGraphicsUnregisterResource, "
    "hipGraphicsUnregisterResource@hip_4.3");
...
__asm__(
    ".symver hipLaunchCooperativeKernelMultiDevice, "
    "hipLaunchCooperativeKernelMultiDevice@hip_4.2");
...
__asm__(
    ".symver hipLaunchCooperativeKernel_spt, "
    "hipLaunchCooperativeKernel_spt@hip_5.2");
...
__asm__(
    ".symver hipMemExportToShareableHandle, "
    "hipMemExportToShareableHandle@hip_5.1");
...
__asm__(
    ".symver hipMemGetAllocationGranularity, "
    "hipMemGetAllocationGranularity@hip_5.1");
...
__asm__(
    ".symver hipMemGetAllocationPropertiesFromHandle, "
    "hipMemGetAllocationPropertiesFromHandle@hip_5.1");
...
__asm__(
    ".symver hipMemGetHandleForAddressRange, "
    "hipMemGetHandleForAddressRange@hip_6.5");
...
__asm__(
    ".symver hipMemImportFromShareableHandle, "
    "hipMemImportFromShareableHandle@hip_5.1");
...
__asm__(
    ".symver hipMemPoolExportToShareableHandle, "
    "hipMemPoolExportToShareableHandle@hip_5.1");
...
__asm__(
    ".symver hipMemPoolImportFromShareableHandle, "
    "hipMemPoolImportFromShareableHandle@hip_5.1");
...
__asm__(
    ".symver hipMemRetainAllocationHandle, "
    "hipMemRetainAllocationHandle@hip_5.1");
...
__asm__(
    ".symver hipMemcpy2DFromArrayAsync_spt, "
    "hipMemcpy2DFromArrayAsync_spt@hip_5.3");
...
__asm__(
    ".symver hipMemcpyFromSymbolAsync_spt, "
    "hipMemcpyFromSymbolAsync_spt@hip_5.3");
...
__asm__(
    ".symver hipModuleLaunchCooperativeKernel, "
    "hipModuleLaunchCooperativeKernel@hip_5.5");
...
__asm__(
    ".symver hipModuleLaunchCooperativeKernelMultiDevice, "
    "hipModuleLaunchCooperativeKernelMultiDevice@hip_5.5");
...
__asm__(
    ".symver hipModuleOccupancyMaxActiveBlocksPerMultiprocessor, "
    "hipModuleOccupancyMaxActiveBlocksPerMultiprocessor@hip_4.2");
...
__asm__(
    ".symver hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags, "
    "hipModuleOccupancyMaxActiveBlocksPerMultiprocessorWithFlags@hip_4.2");
...
__asm__(
    ".symver hipModuleOccupancyMaxPotentialBlockSize, "
    "hipModuleOccupancyMaxPotentialBlockSize@hip_4.2");
...
__asm__(
    ".symver hipModuleOccupancyMaxPotentialBlockSizeWithFlags, "
    "hipModuleOccupancyMaxPotentialBlockSizeWithFlags@hip_4.2");
...
__asm__(
    ".symver hipOccupancyMaxActiveBlocksPerMultiprocessor, "
    "hipOccupancyMaxActiveBlocksPerMultiprocessor@hip_4.2");
...
__asm__(
    ".symver hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags, "
    "hipOccupancyMaxActiveBlocksPerMultiprocessorWithFlags@hip_4.2");
...
__asm__(
    ".symver hipOccupancyMaxPotentialBlockSize, "
    "hipOccupancyMaxPotentialBlockSize@hip_4.2");
...
__asm__(
    ".symver hipSignalExternalSemaphoresAsync, "
    "hipSignalExternalSemaphoresAsync@hip_4.3");
...
__asm__(
    ".symver hipStreamBeginCaptureToGraph, "
    "hipStreamBeginCaptureToGraph@hip_6.1");
...
__asm__(
    ".symver hipStreamGetCaptureInfo_v2_spt, "
    "hipStreamGetCaptureInfo_v2_spt@hip_5.3");
...
__asm__(
    ".symver hipStreamUpdateCaptureDependencies, "
    "hipStreamUpdateCaptureDependencies@hip_4.5");
...
__asm__(
    ".symver hipTexObjectGetResourceViewDesc, "
    "hipTexObjectGetResourceViewDesc@hip_4.2");
...
__asm__(
    ".symver hipTexRefGetMipmapFilterMode, "
    "hipTexRefGetMipmapFilterMode@hip_4.2");
...
__asm__(
    ".symver hipTexRefGetMipmapLevelClamp, "
    "hipTexRefGetMipmapLevelClamp@hip_4.2");
...
__asm__(
    ".symver hipTexRefSetMipmapFilterMode, "
    "hipTexRefSetMipmapFilterMode@hip_4.2");
...
__asm__(
    ".symver hipTexRefSetMipmapLevelClamp, "
    "hipTexRefSetMipmapLevelClamp@hip_4.2");
...
__asm__(
    ".symver hipThreadExchangeStreamCaptureMode, "
    "hipThreadExchangeStreamCaptureMode@hip_5.0");
...
__asm__(
    ".symver hipWaitExternalSemaphoresAsync, "
    "hipWaitExternalSemaphoresAsync@hip_4.3");
